...
public class MapDecorationTracker {
    ...
    public MapDecorationTracker(int scanCadence, int slotsToScan) {
        ...
        persistenceManager.loadChannelSettings(telegramChannel);
    }
    ...
    public void onClientTick(MinecraftClient client) {
        ...
        if (++saveCounter >= SAVE_INTERVAL) {
            saveCounter = 0;
            persistenceManager.saveChannelSettings(telegramChannel);
            persistenceManager.saveMessages(telegramChannel);
        }
    }
